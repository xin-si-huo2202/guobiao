<template>
  <div class="page-img" id="pageImgOther">
    <div class="image-move-wapper">
      <div class="image-show-box" ref="imageShowBoxOther">
        <div
          class="drag-container"
          ref="dragContainerOther"
          :style="
            'left:' +
        ...
        >
          <div class="drag-image-box">
            <img
              :src="src"
              class="imgBox"
              :class="imageHeight==1?'img1':imageHeight==2?'img2':imageHeight==3?'img3':imageHeight==4?'img4':''"
              id="imgBoxOther"
              draggable="false"
              ref="imgDivOther"
              @mousewheel="bigimgOther($event)"
            />
          </div>
        </div>
      </div>
...
export default {
  ...
  updated() {
    ...
    _this.$nextTick(function () {
      _this.dragContainer.box = {
        w: _this.$refs.dragContainerOther.offsetWidth,
        h: _this.$refs.dragContainerOther.offsetHeight,
      };

      _this.imageShowBox.box = {
        w: _this.$refs.imageShowBoxOther.offsetWidth,
        h: _this.$refs.imageShowBoxOther.offsetHeight,
      };
  ...
  methods: {
    ...
    bigimgOther(e) {
      ...
      let box = document.querySelector("#imgBoxOther");
    ...
    MaxBenOther() {
      ...
      //   let box = this.$refs.imgDiv;
      let box = document.querySelector("#imgBoxOther");
      let boxPhotoDetail = document.querySelector("#pageImgOther");
