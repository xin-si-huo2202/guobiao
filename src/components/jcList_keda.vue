            ...
            >
              <template v-if="!input2 || val.carNumber.indexOf(input2) != -1">
                ...
                <ul v-if="val.xiala_bool">
                  ...
                  <li @dblclick.stop="new_bf(1, '云台', val)">云台</li>
                  <li @dblclick.stop="new_bf(2, '左前摄像机', val)">
                    左前摄像机
                  </li>
                  <li @dblclick.stop="new_bf(5, '右前摄像机', val)">
                    右前摄像机
                  </li>
                  <li @dblclick.stop="new_bf(6, '左后摄像机', val)">
                    左后摄像机
                  </li>
                  <li @dblclick.stop="new_bf(9, '右后摄像机', val)">
                    右后摄像机
                  </li>
                </ul>
              </template>
    ...
    async ggp() {
      ...
      try {
        ...
        if (res && res.result && res.result.records.length != 0) {
          ...
          //console.log(this.carList, "所有车辆信息表", this.$route.query.name);
          this.carList.forEach((item, i) => {
          ...
          //console.log(this.carList, "所有车辆信息表ssssssssssssssssss");
