<template>
  <div class="page" v-if="displayShow">
    <div class="top">
      <div class="box">
        <div class="title-box">
          <title-two title="布控人像"></title-two>
        </div>
        <div class="box-img">
      ...
      <div class="box">
        <div class="title-box">
          <title-two title="预警人像"></title-two>
        </div>
        <div class="box-img">
    ...
    <div class="bottom">
      <el-table :data="itemList" style="width: 100%">
        ...
        <!--<el-table-column prop="response" label="反馈信息" v-if="itemList[0].isResponse==1">
          <template slot-scope="scope">
             <el-tooltip
              class="item"
              effect="dark"
              :content="delHtmlTag(scope.row.response)"
              placement="top-start"
            >
              <div class="tab-cons" v-html="scope.row.response"></div>
            </el-tooltip>
          </template>
        </el-table-column>-->
