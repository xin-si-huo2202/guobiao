<template>
  <div class="Map-Video">
    <Map :mapcarlist="mapcarlist" clearmap="true" />
      ...
      <div class="left_mid">
        ...
        <div class="yt_cont bg_color_white">
          ...
          <div class="control_qiu_s">
            ...
            <img
              class="zuoshang_s"
              @mousedown="hkcontrol('LEFT_UP', 0)"
              @mouseup="hkcontrol('LEFT_UP', 1)"
            ...
            <img
              class="zuoxia_s"
              @mousedown="hkcontrol('LEFT_DOWN', 0)"
              @mouseup="hkcontrol('LEFT_DOWN', 1)"
            ...
            <img
              class="youshang_s"
              @mousedown="hkcontrol('RIGHT_UP', 0)"
              @mouseup="hkcontrol('RIGHT_UP', 1)"
            ...
            <img
              class="youxia_s"
              @mousedown="hkcontrol('RIGHT_DOWN', 0)"
              @mouseup="hkcontrol('RIGHT_DOWN', 1)"
          ...
          <div class="zoomzu">
            <el-button
              ...
              @mousedown.native="hkcontrol('ZOOM_IN', 0)"
              @mouseup.native="hkcontrol('ZOOM_IN', 1)"
              >放大</el-button
            >
            <el-button
              type="primary"
            ...
            <el-button
              ...
              @mousedown.native="hkcontrol('ZOOM_OUT', 0)"
              @mouseup.native="hkcontrol('ZOOM_OUT', 1)"
              >缩小</el-button
            >
          </div>
        </div>
      ...
      <div class="videowarp-bot">
        ...
        <div class="Map-Video--left" v-if="!$isie">
          <div class="Map-Video--Video">
            <div
              :style="!doudong ? `flex-wrap:nowrap;` : `flex-wrap:wrap;`"
              style="
                height: 100%;
                width: 100%;
                display: flex;
...
function initPlugin() {
  oWebControl = new WebControl({
      ...
      oWebControl
        ...
        .then(
          function () {
            ...
            oWebControl
              .JS_CreateWnd("playWnd", backbox.width, backbox.height)
              .then(function () {
    ...
    cbConnectError: function () {
      ...
      oWebControl = null;
      $("#playWnd").html(
        "插件未启动，请下载安装后重新刷新页面,<a download href='/playback/demo/VideoWebPlugin.exe'>下载</a>"
      );
...
function init() {
  getPubKey(function () {
    ...
    var buttonIDs = "0,1,16,512,515,256,259"; //自定义工具条按钮
    var reconnectTimes = 0; // 重连次数，回放异常情况下有效
    ...
    async hkcontrol(command, action) {
      try {
        if (
          ...
          setTimeout(async () => {
            var res = await hikControlv2({
              cameraIndexCode: ytcode,
              command,
              action,
              presetIndex: 20,
              speed: this.zhuansu,
        ...
        try {
          this.pingarr.forEach((item2, i2) => {
            if (!item2.jc_data) {
              ...
              console.log(this.pingarr, "调试pingarr=============");
