<template>
  <div class="index_container padding-21">
    <Map :dataList='dataList' :jsdingwei='jsdingwei' />
    ...
    <div class="page-con">
      <div class="left-box ">
        ...
        <div class="uplode-box bg_color_white">
        ...
        <div class="rate-box bg_color_white">
          <div class='slider-s'>
            <el-slider
        ...
        <div class="num-box1 bg_color_white">
          <div class='slider-s'>
            <el-input-number
        ...
        <div class="btnsp bg_color_white">
      ...
      <div class="right-box">
          <div  class="videowarp-left" @click="yidong(2)">
            位置
          </div>
            ...
            <div class="right-con bg_color_white">
              <div class="tab-con" v-if="dataList.length != 0">
                ...
                >
                  ...
                  <div class="cp-btn-weizhi" @click.stop="rxWeiZhi(item)">
...
import { searchFace, selPageFace, selBigImageUrl } from "@/api/faceForm.js";
...
export default {
  ...
  methods: {
    ...
    async selBtn() {
      ...
      try {
        ...
        param.append("startTime", this.queryParams.startTime);
        param.append("endTime", this.queryParams.endTime);
        const res = await searchFace(param);
        if (res.code == 200) {
  ...
  //  this.xiba();
    ...
    if(sessionStorage.getItem('caijiweizhi_date')){
      ...
      this.queryParams.img_usl = caiji_data.smallImageUrl;
