    ...
    <div class="Map-Video">
        ...
        <div class="left">
            ...
            <div class="left_mid">
                ...
                <div class="left_mid_bot">
                    <DepTree  @getDeptDatas="getDeptDatas" @carall='carall'  />
                </div>
            </div>
            <div class="left_bot">
                <div class="maidai">
        ...
        <div class="videowarp">
            <div class="videowarp-top">
                <img :src="require('@/assets/image/flexible-button.svg')"   :class="kto==1?'wai':'nei'" @click="yidong(1)">
            </div>
            ...
            <div class="videowarp-bot">
                ...
                <div class="Map-Video--left" v-if='!$isie'>
                    <img :src="require('@/assets/image/flexible-button.svg')" class="videowarp-left" :class="kto==1?'wai':'nei'" @click="yidong(2)">
                    <div class="Map-Video--Video">
                        ...
                        <div  :style="!doudong?`flex-wrap:nowrap;`:`flex-wrap:wrap;`"  style="height:100%;width:100%;display:flex;overflow:hidden;position:relative;" >
                            <template v-for='(item,i) in pingarr'>
                                <div @click='choose_pl=i'  :class='i==choose_pl?"video3":"video2"' :style="(fornum==3 && item.width=='0%') || (fornum==4 && item.width=='0%') || (isquanping==true && isquanping_ind!=i) ? `opacity:0;width:${item.width};height:${item.height}`:`opacity:1;width:${item.width};height:${item.height}`"  >
                                    <cus-player :jc_data='item.jc_data' :key='item.re'  @des='des' :ind='i' @ended='ended' @quanping='quanping' @bofang='bofang' @error='error' @pause='pause'  :statusind='item.status_ind' :deviceId='item.deviceId' :channelId='item.channelId'  :ref="item.re"></cus-player>
...
import JcList from '../components/jcList2.vue';
...
export default {
    ...
    methods: {
        newBf(data){
            // this.pingarr[this.choose_pl].jc_data=data
            var hk_index=data.index
            var hk_name = data.name
            this.pingarr[this.choose_pl].jc_data = Object.assign({}, data, {hk_index,hk_name })
        },   
        addCar(data){
